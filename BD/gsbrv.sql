...
CREATE TABLE `Motif_visite` (
	`motif_num` int NOT NULL ,
	`motif_libelle` Varchar (100) Not null,
	PRIMARY KEY (`motif_num`));
	
INSERT INTO `Motif_visite` VALUES (1, 'Périodicité'), (2, 'Nouveautés'), (3, 'Remontage'), (4, 'Sollicitation du Praticien'), (5, 'Autre') ;
...
CREATE TABLE `RapportVisite` (
  ...
  `rap_coeff_confiance` float DEFAULT NULL,
  `rap_lu` boolean DEFAULT false,
  `pra_num` int(11) DEFAULT NULL,
  `motif_num` int DEFAULT NULL,
  ...
  CONSTRAINT `FK_RAPPORT_VISITE_MOTIF_VISITE` FOREIGN KEY (`motif_num`) REFERENCES `Motif_visite` (`motif_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `RapportVisite` VALUES
	( 'a131' , 1 , '2020-01-02' , 'RAS' ,'2020-01-03',0, false, 85, 3 ) ,
	( 'a131' , 2 , '2020-03-01' , 'RAS' , '20210-03-02', 5, false, 22, 2  ) ,
	( 'a131' , 3 , '2020-04-03' , 'RAS' ,  '2020-04-04', 1, false, 18, 3 ) ,
	( 'a131' , 4 , '2020-09-10' , 'RAS' , '2020-09-11', 3, false, 84, 4 ) ,
	( 'a131' , 5 , '2020-05-21' , 'RAS' , '2020-05-22', 3, false, 18, 2 ) ; 
